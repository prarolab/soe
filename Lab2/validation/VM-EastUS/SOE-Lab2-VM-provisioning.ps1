...
New-AzureRmResourceGroupDeployment -Name "SOE-Lab1-VMDeployment" -ResourceGroupName $vmimagerg -TemplateFile https://msreadylabs.blob.core.windows.net/workshop/Lab2-SoeVM.json -TemplateParameterObject @{"alias"=$alias}
